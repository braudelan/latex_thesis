...
%  technichal tasks
	...
	% units
	%todo better looking (and consistent) inline unit formatting. maybe define units in the preamble (e.\dfrac{g}{den}. \respunit and \genericunit).
...
%todo check significance between the means (across all LTTs) of each week
			...
			\input{tables/microbial_features_MRE_amended.tex}
